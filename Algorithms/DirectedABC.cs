...
namespace MHPlatTest.Algorithms
{
    ...
    ///    M.S.Kıran and O.Fındık
    ///    Applied Soft Computing 2015 Vol. 26 Pages 454-462
    ///    DOI: https://doi.org/10.1016/j.asoc.2014.10.020
    ///    https://www.sciencedirect.com/science/article/pii/S1568494614005304
    /// </summary>
    internal class DirectedABC : IMHAlgorithm
    {
        ...
        public DirectedABC(List<OptimizationParameter> optimizationConfiguration, string description, int instanceID)
        {
        ...
        /// </summary>
        public string Name { get; set; } = "Directed ABC";
        ...
        public void ComputeOptimum(IBenchmark benchmarkFunction, List<OptimizationResultModel> resultsData, int randomSeed, double[,]? initialSolutions)
        {
            ...
            double[,] directionInformationArray = new double[nbrEmployed, ProblemDimension];
            ...
            for (iterationNumber = 0; iterationNumber < maxItertaionNumber; iterationNumber++)
            {
                ...
                for (int arrayLine = 0; arrayLine < nbrEmployed; arrayLine++)
                {
                    ...
                    double phiValue = 0;
                    double distanceBetweenFoodSources = 0;

                    if (directionInformationArray[arrayLine, dimensionToUpdate] == 1)
                    {
                        phiValue = rand.NextDouble();
                        distanceBetweenFoodSources = Math.Abs(populationArray[arrayLine, dimensionToUpdate] - populationArray[secondFoodSourceID, dimensionToUpdate]);
                    }
                    else if (directionInformationArray[arrayLine, dimensionToUpdate] == -1)
                    {
                        phiValue = -rand.NextDouble();
                        distanceBetweenFoodSources = Math.Abs(populationArray[arrayLine, dimensionToUpdate] - populationArray[secondFoodSourceID, dimensionToUpdate]);
                    }
                    else
                    {
                        ...
                        distanceBetweenFoodSources = populationArray[arrayLine, dimensionToUpdate] - populationArray[secondFoodSourceID, dimensionToUpdate];
                    }
                    ...
                    if (currentParticleFitness > fitnessArray[arrayLine])
                    {
                        ...
                        //Updating direction information for current dimension
                        if (currentParticlePositionArray[dimensionToUpdate] > populationArray[arrayLine, dimensionToUpdate])
                        {
                            directionInformationArray[arrayLine, dimensionToUpdate] = +1;
                        }
                        else
                        {
                            directionInformationArray[arrayLine, dimensionToUpdate] = -1;
                        ...
                        //Update food source with newer position
                    ...
                    else
                    {
                        ...
                        directionInformationArray[arrayLine, dimensionToUpdate] = 0;
                    }
                ...
                for (int arrayLine = 0; arrayLine < nbrOnlooker; arrayLine++)
                {
                    ...
                    {
                        phiValue = rand.NextDouble();
                        distanceBetweenFoodSources = Math.Abs(populationArray[selectedFoodSourceID, dimensionToUpdate] - populationArray[secondFoodSourceID, dimensionToUpdate]);
                    }
                    else if (directionInformationArray[arrayLine, dimensionToUpdate] == -1)
                    {
                        phiValue = -rand.NextDouble();
                    ...
                    {
                        phiValue = (rand.NextDouble() * 2) - 1;
                        distanceBetweenFoodSources = populationArray[selectedFoodSourceID, dimensionToUpdate] - populationArray[secondFoodSourceID, dimensionToUpdate];
                    }
                    ...
                    if (currentParticleFitness > fitnessArray[selectedFoodSourceID])
                    {
                        ...
                        //Updating direction information for current dimension
                        if (currentParticlePositionArray[dimensionToUpdate] > populationArray[selectedFoodSourceID, dimensionToUpdate])
                        {
                            directionInformationArray[selectedFoodSourceID, dimensionToUpdate] = 1;
                        }
                        else
                        {
                            directionInformationArray[selectedFoodSourceID, dimensionToUpdate] = -1;
                        ...
                        //Updating current food source with newer position
                    ...
                    {
                        //newly generated food source is not better
                        directionInformationArray[selectedFoodSourceID, dimensionToUpdate] = 0;
                        ...
                        case PopulationInitilizationType.Random:
                            for (int arrayLine = 0; arrayLine < nbrEmployed; arrayLine++)
                            {
                                for (int arrayColumn = 0; arrayColumn < ProblemDimension; arrayColumn++)
                                {
                                    ...
                                    directionInformationArray[maxLimitValueForFoodSourcesID, arrayColumn] = 0;
                                }
                            }
                            break;
                        default:
